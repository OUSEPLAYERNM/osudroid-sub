...
blur.Image = getcustomasset(notif and 'newvape/assets/new/blurnotif.png' or 'newvape/assets/new/blur.png')
...
tween:Tween(bkg, uipallet.Tween, {BackgroundColor3 = color.Light(uipallet.Main, 0.05)})
end)
...
tween:Tween(knob, uipallet.Tween, {Size = UDim2.fromOffset(16, 16)})
end)
...
if tab.Rainbow ~= self.Rainbow then self:Toggle() end
...
if s then tween:Tween(satSlider.Slider.Fill, uipallet.Tween, {Size = UDim2.fromScale(math.clamp(self.Sat, 0.04, 0.96), 1)}) end
if v then tween:Tween(vibSlider.Slider.Fill, uipallet.Tween, {Size = UDim2.fromScale(math.clamp(self.Value, 0.04, 0.96), 1)}) end
if o then tween:Tween(opSlider.Slider.Fill, uipallet.Tween, {Size = UDim2.fromScale(math.clamp(self.Opacity, 0.04, 0.96), 1)}) end
...
if ind then table.remove(mainapi.RainbowTable, ind) end
...
title.BackgroundTransparency = 1
title.Text = '\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}'..optionsettings.Name..' - '..optionapi.Value
title.TextXAlignment = Enum.TextXAlignment.Left
title.TextColor3 = color.Dark(uipallet.Text, 0.16)
title.TextSize = 13
...
function optionapi:Load(tab)
if self.Value ~= tab.Value then self:SetValue(tab.Value) end
end
function optionapi:Change(list)
optionsettings.List = list or {}
if not table.find(optionsettings.List, self.Value) then self:SetValue(self.Value) end
end
...
title.Text = '\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}'..optionsettings.Name..' - '..self.Value
...
dropdownoption.Text = '\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}'..v
...
function optionapi:Save(tab)
tab[optionsettings.Name] = {Value = self.Value, Max = self.Max}
end
function optionapi:Load(tab)
local newval = tab.Value == tab.Max and tab.Max ~= self.Max and self.Max or tab.Value
if self.Value ~= newval then self:SetValue(newval, nil, true) end
end
...
self.Value = value
tween:Tween(fill, uipallet.Tween, {Size = UDim2.fromScale(math.clamp(pos or math.clamp(value / optionsettings.Max, 0, 1), 0.04, 0.96), 1)})
...
if check or final then optionsettings.Function(value, final) end
end
slider.InputBegan:Connect(function(inputObj)
if (inputObj.UserInputType == Enum.UserInputType.MouseButton1 or inputObj.UserInputType == Enum.UserInputType.Touch) and (inputObj.Position.Y - slider.AbsolutePosition.Y) > (20 * scale.Scale) then
...
valuebox.Visible = false
if enter and tonumber(valuebox.Text) then optionapi:SetValue(tonumber(valuebox.Text), nil, true) end
end)
optionapi.Object = slider
api.Options[optionsettings.Name] = optionapi
return optionapi
...
optionsettings.Function = optionsettings.Function or function() end
function optionapi:Save(tab)
tab[optionsettings.Name] = {List = self.List, ListEnabled = self.ListEnabled}
end
function optionapi:Load(tab)
...
if ind then table.remove(self.ListEnabled, ind) end
else
...
for _, v in self.Objects do v:Destroy() end
...
tween:Tween(addbkg, uipallet.Tween, {BackgroundColor3 = color.Light(uipallet.Main, 0.14)})
end)
addvalue.MouseLeave:Connect(function()
tween:Tween(addbkg, uipallet.Tween, {BackgroundColor3 = color.Light(uipallet.Main, 0.02)})
end)
close.MouseButton1Click:Connect(function()
window.Visible = false
end)
...
if optionsettings.Default then optionapi:ChangeValue() end
...
toggle.Text = '\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}'..optionsettings.Name
...
function optionapi:Load(tab)
if self.Enabled ~= tab.Enabled then self:Toggle() end
end
function optionapi:Color(hue, sat, val, rainbowcheck)
...
local rainbowcheck = mainapi.GUIColor.Rainbow and (not mainapi.RainbowMode or mainapi.RainbowMode.Value ~= 'Retro')
...
tween:Tween(knob, uipallet.Tween, {Position = UDim2.fromOffset(self.Enabled and 12 or 2, 2)})
...
valuebutton.Visible = true
valuebox.Visible = false
if enter and tonumber(valuebox.Text) then optionapi:SetValue(true, tonumber(valuebox.Text)) end
end)
valuebox2.FocusLost:Connect(function(enter)
valuebutton2.Visible = true
valuebox2.Visible = false
if enter and tonumber(valuebox2.Text) then optionapi:SetValue(false, tonumber(valuebox2.Text)) end
end)
optionapi.Object = slider
api.Options[optionsettings.Name] = optionapi
return optionapi
...
label.Text = '\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}'..text:upper()
...
button.BorderSizePixel = 0
button.AutoButtonColor = false
button.Text = '\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}Rebind GUI'
...
button.BorderSizePixel = 0
button.AutoButtonColor = false
button.Text = (categorysettings.Icon and '\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}' or '\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}')..categorysettings.Name
button.TextXAlignment = Enum.TextXAlignment.Left
button.TextColor3 = color.Dark(uipallet.Text, 0.16)
button.TextSize = 14
button.FontFace = uipallet.Font
...
function optionapi:Toggle()
self.Enabled = not self.Enabled
tween:Tween(arrow, uipallet.Tween, {Position = UDim2.new(1, self.Enabled and -14 or -20, 0, 16)})
...
if categorysettings.Window then categorysettings.Window.Visible = self.Enabled end
end
button.MouseEnter:Connect(function()
if not optionapi.Enabled then
...
addCorner(shadow)
local owindow = Instance.new('Frame')
owindow.Size = UDim2.fromOffset(220, 42)
owindow.Position = UDim2.fromScale(0, 1)
owindow.BackgroundColor3 = uipallet.Main
owindow.Parent = shadow
addCorner(owindow)
local icon = Instance.new('ImageLabel')
icon.Name = 'Icon'
...
title.TextSize = 15
title.FontFace = uipallet.Font
title.Parent = owindow
local close = addCloseButton(owindow, 7)
local divider = Instance.new('Frame')
divider.Name = 'Divider'
divider.Size = UDim2.new(1, 0, 0, 1)
...
toggle.AutoButtonColor = false
toggle.Text = string.rep('\u{200A}', 33 * scale.Scale)..togglesettings.Name
toggle.TextXAlignment = Enum.TextXAlignment.Left
toggle.TextColor3 = color.Dark(uipallet.Text, 0.16)
toggle.TextSize = 14
toggle.FontFace = uipallet.Font
...
tween:Tween(knobmain, uipallet.Tween, {Position = UDim2.fromOffset(self.Enabled and 12 or 2, 2)})
...
tween:Tween(button, uipallet.Tween, {BackgroundTransparency = 0.9})
end)
button.MouseLeave:Connect(function()
button.ImageColor3 = color.Light(uipallet.Main, 0.37)
...
tween:Tween(owindow, uipallet.Tween, {Position = UDim2.new(0, 0, 1, -(owindow.Size.Y.Offset))})
end)
close.MouseButton1Click:Connect(function()
tween:Tween(shadow, uipallet.Tween, {BackgroundTransparency = 1})
tween:Tween(owindow, uipallet.Tween, {Position = UDim2.fromScale(0, 1)})
task.wait(0.2)
shadow.Visible = false
end)
...
if mainapi.ThreadFix then setthreadidentity(8) end
owindow.Size = UDim2.fromOffset(220, math.min(37 + windowlist.AbsoluteContentSize.Y / scale.Scale, 605))
childrentoggle.Size = UDim2.fromOffset(220, owindow.Size.Y.Offset - 5)
end)
...
button.BorderSizePixel = 0
button.AutoButtonColor = false
button.Text = '\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}'..categorysettings.Name
button.TextXAlignment = Enum.TextXAlignment.Left
button.TextColor3 = color.Dark(uipallet.Text, 0.16)
button.TextSize = 14
button.FontFace = uipallet.Font
...
if v.Icon then
v.Object.Text = string.rep('\u{200A}', 33 * scale.Scale)..v.Name
end
end
end)
return optionapi
...
optionapi:SetValue(name == 'Custom color' and value or nil, name == 'Saturation' and value or nil, name == 'Vibrance' and value or nil, name == 'Opacity' and value or nil)
end
end)
local ended
ended = inputObj.Changed:Connect(function()
...
local rainbowthread
function optionapi:Save(tab)
tab[optionsettings.Name] = {Hue = self.Hue, Sat = self.Sat, Value = self.Value, Notch = self.Notch, CustomColor = self.CustomColor, Rainbow = self.Rainbow}
end
function optionapi:Load(tab)
if tab.Rainbow then self:Toggle() end
...
if n then
if self.Rainbow then self:Toggle() end
...
tween:Tween(knob, uipallet.Tween, {Position = UDim2.fromOffset(slidercolorpos[4] - 3, -5)})
else
knob.Image = normalknob
knob.ImageColor3 = Color3.fromHSV(self.Hue, self.Sat, self.Value)
tween:Tween(knob, uipallet.Tween, {Position = UDim2.fromOffset(slidercolorpos[n or 4] - 3, -5)})
end
if self.Rainbow then
if h then colorSlider.Slider.Fill.Size = UDim2.fromScale(math.clamp(self.Hue, 0.04, 0.96), 1) end
if s then satSlider.Slider.Fill.Size = UDim2.fromScale(math.clamp(self.Sat, 0.04, 0.96), 1) end
if v then vibSlider.Slider.Fill.Size = UDim2.fromScale(math.clamp(self.Value, 0.04, 0.96), 1) end
else
if h then tween:Tween(colorSlider.Slider.Fill, uipallet.Tween, {Size = UDim2.fromScale(math.clamp(self.Hue, 0.04, 0.96), 1)}) end
if s then tween:Tween(satSlider.Slider.Fill, uipallet.Tween, {Size = UDim2.fromScale(math.clamp(self.Sat, 0.04, 0.96), 1)}) end
if v then tween:Tween(vibSlider.Slider.Fill, uipallet.Tween, {Size = UDim2.fromScale(math.clamp(self.Value, 0.04, 0.96), 1)}) end
end
...
for _, v in categoryapi.Buttons do
if v.Icon then
v.Object.Text = string.rep('\u{200A}', 36 * scale.Scale)..v.Name
end
end
end)
...
modulebutton.Text = '\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}\u{200A}'..modulesettings.Name
...
if not moduleapi.Enabled then dots.ImageColor3 = uipallet.Text end
end)
dotsbutton.MouseLeave:Connect(function()
if not moduleapi.Enabled then dots.ImageColor3 = color.Light(uipallet.Main, 0.37) end
end)
...
if mobileButton.Bind.Button then mobileButton.Bind.Button.Visible = true end
end
...
for _, mobileButton in mainapi.Modules do
if mobileButton.Bind.Button then mobileButton.Bind.Button.Visible = false end
end
...
for _, v in categoryapi.Connections do v:Disconnect() end
table.clear(categoryapi.Connections)
end
if categorysettings.Function then task.spawn(categorysettings.Function, callback) end
end,
Icon = categorysettings.Icon,
Size = categorysettings.Size,
...
if self.Expanded then self:Expand() end
...
dotsbutton.MouseEnter:Connect(function()
if not children.Visible then dots.ImageColor3 = uipallet.Text end
end)
dotsbutton.MouseLeave:Connect(function()
if not children.Visible then dots.ImageColor3 = color.Light(uipallet.Main, 0.37) end
end)
dotsbutton.MouseButton1Click:Connect(function()
...
if button:FindFirstChild('Bind') then button.Bind:Destroy() end
button.MouseButton1Click:Connect(function() v:Toggle() end)
...
if v.Object:FindFirstChild('UIGradient') then
button.UIGradient.Color = v.Object.UIGradient.Color
button.UIGradient.Enabled = v.Object.UIGradient.Enabled
end
if v.Object:FindFirstChild('Dots') and v.Object.Dots:FindFirstChild('Dots') then
...
if tween.Tween then
tween:Tween(notification, TweenInfo.new(0.4, Enum.EasingStyle.Exponential), {AnchorPoint = Vector2.new(1, 0)}, tween.tweenstwo)
tween:Tween(progress, TweenInfo.new(duration, Enum.EasingStyle.Linear), {Size = UDim2.fromOffset(0, 2)})
end
task.delay(duration, function()
if tween.Tween then
tween:Tween(notification, TweenInfo.new(0.4, Enum.EasingStyle.Exponential), {AnchorPoint = Vector2.new(0, 0)}, tween.tweenstwo)
end
task.wait(0.2)
...
if v.Type == 'Overlay' and v.Button and v.Button.Enabled then v.Button:Toggle() end
end
